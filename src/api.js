const USER_ID = 1;
// We use a relative path "/api" to ensure requests go through CloudFront (the same origin).
// CloudFront then proxies these requests to the HTTP Backend (ALB).
// This prevents "Mixed Content" errors (HTTPS -> HTTP) and simplifies configuration.
